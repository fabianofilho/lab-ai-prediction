...
_REGISTRY: dict[str, dict] = {
    ...
    "uso_uti": {
        "module": "core.outcomes.uso_uti",
        "class":  "UsoUTI",
        "name":   "Uso de UTI na Internação",
        "description": "Prediz se uma internação utilizará UTI, a partir de características de admissão do SIH-RD.",
        "data_sources": ["SIH"],
        "icon": "vital_signs",
        "estimated_download_min": 10,
    },
    ...
    "cesarea": {
        "module": "core.outcomes.cesarea",
        "class":  "Cesarea",
        "name":   "Parto Cesariana",
        "description": "Prediz a probabilidade de parto cesáreo a partir de características maternas e do pré-natal (SINASC).",
        "data_sources": ["SINASC"],
        "icon": "pregnant_woman",
        "estimated_download_min": 5,
    },
    "anomalia_congenita": {
        "module": "core.outcomes.anomalia_congenita",
        "class":  "AnomaliaCongenita",
        "name":   "Anomalia Congênita",
        "description": "Prediz presença de anomalia/malformação congênita ao nascer (SINASC).",
        "data_sources": ["SINASC"],
        "icon": "neurology",
        "estimated_download_min": 5,
    },
